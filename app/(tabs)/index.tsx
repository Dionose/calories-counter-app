...
export default function Home() {
  ...
  return (
    <View style={s.screen}>
      ...
      {/* DEV toggle — sits above the tab bar, clear of the status bar. Remove before launch. */}
...
const styles = (T: any) =>
  StyleSheet.create({
    ...
    greeting: { fontSize: 24, color: T.text, fontFamily: FONTS.heading },
    date: { fontSize: 10, letterSpacing: 1.2, color: T.micro, fontFamily: FONTS.body, marginTop: 4 },
