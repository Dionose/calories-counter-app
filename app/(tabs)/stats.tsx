// app/(tabs)/stats.tsx
import { Activity, Check, ChevronLeft, Flame, Footprints, TrendingDown, Watch } from "lucide-react-native";
...
// turn 8400 into "8.4k", 11200 into "11.2k"
      ...
      {CONNECTED ? (
        ...
        <TravelBorder color={T.green} cardBg={T.card} borderColor={T.border} radius={20}>
          <View style={{ padding: 22, alignItems: "center" }}>
            ...
            <Text style={styles.connectSub}>Sync steps, calories burned & heart rate from Apple Watch, Garmin, Samsung & more.</Text>
  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll}>
      ...
      <Pressable onPress={save} style={[styles.saveBtn, saved && styles.saveBtnDone]}>
        {saved ? (
          <View style={styles.rowCenter}><Check size={17} color={T.green} /><Text style={styles.saveTextDone}>Calibrated!</Text></View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  toggle: { flexDirection: "row", gap: 4, backgroundColor: T.cardHi, borderWidth: 1, borderColor: T.border, borderRadius: 12, padding: 4, marginBottom: 16 },
  ...
  connectIcon: { width: 48, height: 48, borderRadius: 15, backgroundColor: T.greenBg, borderWidth: 1, borderColor: T.greenBorder, alignItems: "center", justifyContent: "center", marginBottom: 12 },
  connectTitle: { fontSize: 15, color: T.text, fontFamily: FONTS.headingMed, marginBottom: 4 },
  ...
  calFill: { height: "100%", borderRadius: 8, flexDirection: "row", alignItems: "center", justifyContent: "flex-end", paddingRight: 8, minWidth: 82 },
  ...
  tapBadge: { borderWidth: 1, borderColor: T.greenBorder, borderRadius: 5, paddingHorizontal: 5, paddingVertical: 1 },
  ...
  typicalLabel: { fontSize: 9.5, color: T.micro, fontFamily: FONTS.body, marginTop: 2, textTransform: "uppercase", letterSpacing: 0.6 },
  ...
  diffCard: { backgroundColor: T.cardHi, borderWidth: 1, borderColor: T.border, borderRadius: 14, padding: 14, marginTop: 14, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  diffLabel: { fontSize: 12, color: T.sub, fontFamily: FONTS.body },
  diffValue: { fontSize: 14, fontFamily: FONTS.heading },
