...
//
// Someone who's just double-logged lunch is looking at Home. Making them find
// the calendar to fix it would mean teaching them the calendar exists, which
// is a worse answer than putting the fix where they already are.
//
...
// worse than being told nothing. Making the fix easy to find beats guessing at
// intent.
//
          ...
          <View style={s.card}>
            ...
            >
              ...
              {meal.items.map((item, i) => {
                ...
                return (
                  <View key={item.id || i} style={{ marginBottom: 9 }}>
                    <View style={[s.itemRow, hasParts && s.itemRowDish]}>
...
const styles = (T: any) =>
  StyleSheet.create({
    ...
    itemRowDish: { borderColor: `${T.gold}55`, backgroundColor: "rgba(251,191,36,0.05)" },
    ...
    partsWrap: {
      ...
      borderWidth: 1, borderTopWidth: 0, borderColor: `${T.gold}44`,
      borderBottomLeftRadius: 14, borderBottomRightRadius: 14,
      marginTop: -3, paddingHorizontal: 13, paddingTop: 8, paddingBottom: 11,
    },
    partRow: {
      flexDirection: "row", alignItems: "center", gap: 10,
      paddingVertical: 6,
    ...
    partsFoot: { fontSize: 10, color: T.micro, fontFamily: FONTS.body, marginTop: 8 },
